...
public class DialView extends View {
    ...
    private float mStartAngle = 157.5f; // 起始角度
    private float mSweepAngle = 225; // 绘制角度
    ...
    private String mHeaderText = "当前已减免85%"; // 表头
   ...
   /*     mPaint.setShader(null);
        ...
        float degree = mSweepAngle / mSection * 2;
        for (int i = 0; i < 2; i++) {
...
//        }
        ...
        canvas.drawText(value, mCenterX, mCenterY - (mPaint.ascent() + mPaint.descent()) / 2, mPaint);
        ...
        canvas.drawText(mHeaderText, mCenterX, mCenterY + dp2px(50), mPaint);
        ...
        canvas.drawText(calculateCreditDescription(), mCenterX, mCenterY - dp2px(30), mPaint);
